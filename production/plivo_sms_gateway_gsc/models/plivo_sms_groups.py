...
class PlivoSmsGroups(models.Model):
    _name = 'plivo.sms.groups'
    _description = "Plivo SMS Groups"
    ...
    recipients = fields.Many2many("res.partner", 'plivo_sms_groups_res_partner_rel', 'sms_group_id', 'partner_id',
